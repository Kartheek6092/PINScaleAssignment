    ...
    render(){
        ...
        return(
            <nav className='left-nav-bar'>
                <div>
                    <img src='https://res.cloudinary.com/dzjuhiwxw/image/upload/v1690644580/BankApp/Logo_xfgvg8.png' alt='website logo' className='website-logo' />
                ...
                <div className='nav-profile'>
                    <img className='profile-icon' src='https://res.cloudinary.com/dzjuhiwxw/image/upload/v1690800579/BankApp/Avatar_b3d4gj.png' alt='profile icon' />
